...
object DataSenjata {
    private val namaSenjata = arrayOf(
        "Dual Blade",
        "Gunlance",
        "GreatSword",
        "Heavy Bowgun",
    ...
    private val destripsiSenjata = arrayOf(
    ...
    private val gambarSenjata = intArrayOf(
        R.drawable.db,
        R.drawable.gl,
        R.drawable.gs,
        R.drawable.hbg,
    ...
    val listData: ArrayList<Senjata>
        get() {
            val list = arrayListOf<Senjata>()
            for (position in namaSenjata.indices) {
                val senjata = Senjata()
                senjata.nama = namaSenjata[position]
                senjata.desktripsi = destripsiSenjata[position]
                senjata.photo = gambarSenjata[position]
                list.add(senjata)
            }
            return list
        }
